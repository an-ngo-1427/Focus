...
def seed_rewards():
    ...
    reward20 = Reward(receiver_id=4, gifter_id=7, amount= 3)
    ...
    db.session.add_all([reward1, reward2, reward3, reward4, reward5, reward6, reward7, reward8, reward9, reward10, reward11, reward12, reward13, reward14, reward15, reward16, reward17, reward18, reward19, reward20])
    db.session.commit()
