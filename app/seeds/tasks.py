...
def seed_tasks():
    ...
    task1 = Task(title ='1',notes = 'notes for task 1',deadline = convertDate("01/12/2024"),tag = 'creative',difficulty = 2,completed = True,group_id = 1 )
    ...
    task3 = Task(title ='3',notes = 'notes for task 3',deadline =convertDate("06/12/2024"),tag = 'creative',difficulty = 1,completed = True,group_id = 1 )
    ...
    task6 = Task(title ='6',notes = 'notes for task 6',deadline =convertDate("01/03/2024"),tag = 'creative',difficulty = 3,completed = True,group_id = 2 )
    ...
    task11 = Task(title ='11',notes = 'notes for task 11',deadline =convertDate("07/12/2024"),tag = 'creative',difficulty = 2,completed = True,group_id = 3 )
    ...
    task14 = Task(title ='14',notes = 'notes for task 14',deadline =convertDate("01/12/2024"),tag = 'creative',difficulty = 2,completed = True,user_id = 1)
